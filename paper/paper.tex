...
\section{Classifying automata}
    ...
    \begin{itemize}
        ...
        \item Class Two: rapidly converge to a repetitive or stable state e.g.
            Rule 250
        \item Class Three: appear to remain in a random state e.g. Rule 150, 182
    ...
    applying the ruleset, two-dimensional automata have a wider choice. Two of
    the most common types of neighbourhood to consider are the Moore
    neighbourhood and the von Neumann neighbourhood. The former includes the 8
    cells directly surrounding the current cell being considered, while the
    latter only focuses on the four orthogonally ajacent cells. Ocassionally,
    one may use the extended von Neumann neighbourhood. 
